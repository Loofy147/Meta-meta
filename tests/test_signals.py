...
class TestSignalEngine(unittest.TestCase):
    ...
    def test_generate_signals_buy(self, mock_sentiment, mock_macd_signal, mock_rsi_signal):
    ...
    @patch('signals.strategies.macd.generate_signal')
    @patch('signals.strategies.sentiment.generate_signal')
    def test_generate_signals_sell(self, mock_sentiment, mock_macd_signal, mock_rsi_signal):
        # Mock strategy outputs
    ...
    @patch('signals.strategies.macd.generate_signal')
    @patch('signals.strategies.sentiment.generate_signal')
    def test_generate_signals_hold(self, mock_sentiment, mock_macd_signal, mock_rsi_signal):
        # Mock strategy outputs
